...
import rightThumb from "assets/images/homeV3/Multi_Chain_Support.png";
import IntegrationStyleWrapper from "./IntegrationTwo.style";

const IntegrationTwo = () => {
  return (
    <IntegrationStyleWrapper>
      <div className="container" id="integration2">
